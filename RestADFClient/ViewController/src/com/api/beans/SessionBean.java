...
public class SessionBean implements Serializable {
    ...
    public void inputFileValueChangeListener(ValueChangeEvent valueChangeEvent) {
        if (valueChangeEvent.getNewValue() != null) {
            ...
            File file = FileClientUtil.uploadedFileToFileConverter(uploadFile);
            FileClientUtil.fileUpload("http://localhost:8080/uploadFile", file);
        }
    }
    ...
    public void imageInputValueChangeListener(ValueChangeEvent valueChangeEvent) {
        if (valueChangeEvent.getNewValue() != null) {
            ...
            String FileExtension = FileClientUtil.getFileExtn(filename);
